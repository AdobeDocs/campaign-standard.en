...
If enabled, you can modify images with the Adobe Creative SDK. See [Modifying images with the Adobe Creative SDK](images.md#modifying-images-with-the-adobe-creative-sdk).
