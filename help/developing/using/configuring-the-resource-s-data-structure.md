...
Best practices around internal names:
...
>[!IMPORTANT]
>
>Auto-generated identifiers should not be used as a reference in a workflow or in a package definition (and they cannot be). This value is specific to an Adobe Campaign instance. => here???