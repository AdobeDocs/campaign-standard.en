...
uuid: e6e6d933-4f31-4649-a4ec-182a84af7037
...
discoiquuid: bc42e9ea-e6ca-4518-b311-db98dd67b15c
isreadyforlocalization: false
navTitle: Extract file
publishexternaldate: 2018-11-20
sha1: 4357ae3cd8bb40d8d7f4378a0bd00e5e2d9d3be8
index: y
internal: n
snippet: y
---
...
1. In the **Properties** tab, select the **Do not generate a file if the inbound transition is empty** option to avoid creating and uploading empty files on SFTP servers if the inbound transition is empty.
