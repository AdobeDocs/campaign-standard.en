...
NOTE
WF design and execution must be performed by an Adobe Campaign advanced user.
...
By default, we recommend not to run more than 20 workflows simultaneously. After hitting that limit, workflows will be queued in order not to affect performances. Similarly, Adobe recommends you to spread out your workflow exection over time.
...
### Naming of the activity{#activity-naming}
