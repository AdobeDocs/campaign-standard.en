...
uuid: 6f898321-152a-4501-ad49-4f98617bbeeb
content-encoding: ISO-8859-1
aemsrcnodepath: /content/help/en/campaign/standard/administration/using/organizational-units
contentOwner: sauviat
products: SG_CAMPAIGN/STANDARD
audience: administration
content-type: reference
topic-tags: users-e-security
discoiquuid: f21e03a4-5aea-40aa-968f-4656e0cb0b8e
isreadyforlocalization: false
navTitle: Organizational units
publishexternaldate: 2018-11-20
sha1: f4d94f857468013f77a780d4d26da4e76dfeb1b9
index: y
internal: n
snippet: y
---
...
Organizational units allow you to filter your tenant depending on the organization your users are linked to. This unit can represent a region, country or even a brand in your instance.
...
1. From Adobe campaign advanced menu, select **Administration** > **Users & security** > **Organizational units**.
1. Click **Create **to start configuring your organizational unit.

   ![](assets/manage_units_1.png)

1. Change the default **Label** and **ID** to Geometrixx.
1. Then, link this unit to a parent unit. Here, we chose **All**.

   ![](assets/manage_units_2.png)

1. Finally, click **Create** to start assigning your new organizational unit to security group.
...
1. In the **Access authorization** drop down menu, select the organizational unit.
...
Organizational units can restrict the access to different products such as profiles. For example, if our Geometrixx Clothes user access the **Profiles** tab, he will be able to fully access and modify the profiles with the Geometrixx Clothes organizational unit.
...
The organizational unit field is added to your profiles in the **Access authorization** section. 
