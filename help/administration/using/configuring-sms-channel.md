...
1. Define the SMS-C specific parameters in case you need to define a specific encoding mapping. For more information, refer to the [SMSC specifics](../../administration/using/#smsc-specifics) section.
