...
For this use case to work, you need to create rules for PII postbacks. For more information, see PII Postbacks. TO BE ADDED
...
You need to create rules for push notifications tracking postback. For more information, see Push notifications tracking postback. TO BE ADDED
