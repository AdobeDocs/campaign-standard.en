...
uuid: cb9f3ca8-5220-42e4-97ff-c709ce08553a
...
discoiquuid: ea9ab52f-b60d-45a3-a47f-8b080c8bcf51
isreadyforlocalization: false
navTitle: Configuring transactional messaging
publishexternaldate: 2018-11-20
sha1: ac8e5bfff9e59d12c7ccb456d3e06b2aa5f5d793
index: y
internal: n
snippet: y
---
...
This collection can be used in a transactional email to add loops to the content of the message, for example a list of products, with the price, reference number, quantity, etc. for each product of the list.
...
* [Using loops in a transactional message](../../channels/using/event-transactional-messages.md#using-loops-in-a-transactional-message)
...
1. Select the resource with which you want to link your message. In this case, choose the **Profile** resource.
...
1. In the **Targeting enrichment** section, select the enrichment that will be used as the message target during the delivery execution. In this example, select **Profile**. Selecting a targeting enrichment is mandatory for profile-based events. 
