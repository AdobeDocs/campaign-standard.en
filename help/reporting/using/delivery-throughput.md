...
>[!NOTE]
>
>Once upgraded to the Enhanced MTA, the **[!UICONTROL Delivery throughput]** page will no longer display the throughput to your email recipients. It will show the throughput speed for the relay of your messages from Campaign over to the Enhanced MTA.
>
