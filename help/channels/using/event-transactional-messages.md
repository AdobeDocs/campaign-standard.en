...
uuid: 7cd04adf-c303-44cf-ab4c-7606cf6b0bf3
contentOwner: sauviat
products: SG_CAMPAIGN/STANDARD
audience: channels
content-type: reference
topic-tags: transactional-messaging
discoiquuid: a45a6373-c99a-493f-b655-c1a847761533
...
>[!CAUTION]
>
>Loops are only available when editing transactional email messages through the [Email Designer](../../designing/using/about-email-content-design.md#about-the-email-designer) interface.

To add a list of abandoned products in a transactional message, follow the steps below.

>[!NOTE]
>
>Adobe Campaign does not support nested loops, meaning that you cannot include a loop inside another loop.
...
1. Select the structure component you just created and click the **[!UICONTROL Create a loop]** icon from the contextual toolbar.

   ![](assets/message-center_loop_create.png)

   The structure component is highlighted with an orange frame and the **[!UICONTROL Loop]** settings are displayed in the left palette.
...
1. Select how the elements of the collection will be displayed:
   ...
   >[!NOTE]
   >
   >The **[!UICONTROL Column]** option is only available when using a multicolumn structure component ( **[!UICONTROL 2:2 column]** , **[!UICONTROL 3:3 column]** and **[!UICONTROL 4:4 column]** ). When editing the loop, only fill in the first column: the other columns will not be taken into account. For more on selecting structure components, see [Editing the email structure](../../designing/using/defining-the-email-structure.md#editing-the-email-structure).
...
1. Use the **[!UICONTROL First item of loop]** drop-down list to select which element will start the list displayed in the email.
...
1. Select the structure component on which the loop is applied and select **[!UICONTROL Show fallback]** to define a default content.
