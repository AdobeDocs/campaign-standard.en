...
uuid: b0d9a3cf-7f43-43e8-9925-d4e998bad2eb
contentOwner: sauviat
products: SG_CAMPAIGN/STANDARD
audience: channels
content-type: reference
topic-tags: landing-pages
discoiquuid: b55c3584-d42f-43ff-be86-15b9ac11c45a
index: y
internal: n
snippet: y
---
...
1. Choose a database field to link with the form field in the **[!UICONTROL Field]** selection zone.
   ...
   By default, landing pages are mapped with **Profiles**. You can modify the target mapping and select a different one via the **[!UICONTROL Edit properties]** button in the action bar. This modification can be performed at the template level.
