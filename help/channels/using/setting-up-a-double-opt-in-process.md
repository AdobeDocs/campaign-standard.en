...
uuid: 36b7738d-659c-47d7-88f5-04d43c26f4ca
contentOwner: sauviat
products: SG_CAMPAIGN/STANDARD
audience: channels
content-type: reference
topic-tags: landing-pages
discoiquuid: 4923ce43-adc0-454b-907e-469b60366e96
index: y
internal: n
snippet: y
---
...
1. In the **[!UICONTROL Job]** > **[!UICONTROL Form parameter mapping]** section, click **[!UICONTROL Add an element]** and enter the following context path:
...
1. Edit the landing page properties: in the **[!UICONTROL Job]** > **[!UICONTROL Form parameter mapping]** section, click **[!UICONTROL Add an element]** and enter the following context path:
