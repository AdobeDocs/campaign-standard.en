...
* **[!UICONTROL Edit properties]**: lets you edit the message's (advanced parameters)[/help/administration/using/configuring-email-channel.md#list-of-email-properties].
