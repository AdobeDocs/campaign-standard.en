...
uuid: e1243f6e-7143-411b-af63-362fa09d4238
...
discoiquuid: 622cd56a-f5f5-4264-afd2-500e2e23d942
isreadyforlocalization: false
navTitle: Creating an email
publishexternaldate: 2018-11-20
sha1: 8a9a9fb22097d9ac8532b363d9c82ba1556183b6
index: y
internal: n
snippet: y
---
...
1. Define and personalize the message content, sender name and subject. Then preview your message.
   ...
   At this stage in the creation wizard, you can choose to use the default editor or to try the Creative Designer for email ("Beta"). To be able to try the [Creative Designer](../../designing/using/about-email-content-design.md#using-the-email-designer), you need to read and accept the terms and conditions displayed when choosing this option.
