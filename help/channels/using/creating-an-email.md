...
1. Confirm creating the email.
   ...
   The [**[!UICONTROL Edit properties]** button in the upper-right corner allows you to edit the properties of the email. You can, for example, configure the delivery so that its label is compute at the preparation time.  Available parameters are listed in (this section)[/help/administration/using/configuring-email-channel.md#list-of-email-properties].
