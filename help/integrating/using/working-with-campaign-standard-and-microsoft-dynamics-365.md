...
The integration also supports custom entities, enabling [custom entities](../../integratng/using/map-campaign-custom-resources-and-dynamics-365-custom-entities.md) in Dynamics 365 to be synchronized to corresponding custom entities in Campaign.
