...
>[!IMPORTANT]
>
>Adobe Experience Platform Data Connector is now deprecated. Deprecated capabilities are still available, but they are not be further enhanced, nor supported. Learn more [in this page](../../rn/using/deprecated-features.md)
