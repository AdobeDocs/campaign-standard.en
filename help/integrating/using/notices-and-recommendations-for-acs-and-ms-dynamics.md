...
Please be aware that only Campaign attributes with the 'No longer contact by' prefix (e.g., No longer contact by email) or the specific attribute for CCPA opt-out can be used in opt-out mappings. [Learn more](../../developing/using/datamodl-profile.md).
