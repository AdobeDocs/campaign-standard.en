...
uuid: 8b8f70e5-bfbb-4074-9af7-d92e99cc40bf
contentOwner: sauviat
products: SG_CAMPAIGN/STANDARD
audience: start
content-type: reference
topic-tags: discovering-the-interface
discoiquuid: 3d4616ee-56c3-4245-957f-c689cb32cf7f
index: y
internal: n
snippet: y
---
...
* The **[!UICONTROL Programs & campaigns]** card takes you to the list of programs in which you can display, create, and manage your campaigns. Refer to [Program list](../../start/using/programs-and-campaigns.md#about-plans--programs-and-campaigns).
...
* The **[!UICONTROL Audiences]** card takes you directly to the list of audiences. From here you can create new sets of individuals. Refer to [Managing audiences](../../audiences/using/about-audiences.md).
...
* The **[!UICONTROL Adobe Campaign]** logo in the top left-hand corner of the page gives you access to the advanced functions. The menus offered depend on the permissions allocated to the user connected.
...
* The **User** icon allows you to display information linked to the current user. It gives access to the **[!UICONTROL Sign out]** button.
...
* **[!UICONTROL Content templates]** - for more on this, refer to the [Loading an existing content](../../designing/using/selecting-an-existing-content.md) section.

### Administration {#administration}

The **[!UICONTROL Administration]** icon gives you access to the advanced functionalities that can only be carried out by functional administrator. For more on this, refer to the [Administration](../../administration/using/about-administrating-adobe-campaign.md) chapter.
