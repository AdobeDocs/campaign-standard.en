...
+ [Configuring a mobile application using SDK V5](administration/using/configuring-a-mobile-application-using-sdk-v5.md)
...
+ [Sending an In-App message](channels/using/sending-an-in-app-message.md)
...
+ [Creating an In-App message](channels/using/creating-an-in-app-message.md)
