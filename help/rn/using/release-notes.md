...
* **Email Feedback service**:
  * Email Feedback Service is a scalable service which captures feedback from the Enhanced MTA directly, thus improving reporting accuracy.
  ...
  * All events (sync and async bounces) are being processed by the Inmail process: EFS solves the problem of sync bounces and takes 80% of load off from the process.
