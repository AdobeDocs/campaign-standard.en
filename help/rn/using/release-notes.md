...
uuid: 1796885d-4983-48e8-bbfd-f0f427bb120a
content-encoding: UTF-8
aemsrcnodepath: /content/help/en/campaign/standard/rn/using/release-notes
contentOwner: sauviat
cq-designpath: /etc/designs/help
cq-lastmodified: 2018-10-16T08 34 54.644-0400
cq-lastmodifiedby: vignes
cq-lastreplicated: 2018-10-16T08 34 54.679-0400
...
discoiquuid: d8a328ff-5b90-45f7-88a7-eaf515feac32
firstPublishExternalDate: 2018-09-08T12:39:22.604-0400
firstpublishinternaldate: 2018-09-19T09 31 15.788-0400
herogradient: light
...
jcr-language: en_us
lastPublishExternalDate: 2018-10-16T08:34:54.637-0400
lastpublishinternaldate: 2018-10-16T08 34 54.637-0400
lochandoffdate: 2018-09-10T04 10 43.997-0400
...
sha1: f341d7e7a543509c32d93567b20deb9ca2c5667c
topicBrowsingSortDate: 2018-10-16T08:34:54.637-0400
index: y
internal: n
snippet: y
---
...
* When configuring a mobile application in Campaign, the user can now know if the iOS certificate and Android server key have been successfully uploaded and their expiration date.
  ...
  For more on this, refer to the detailed documentation on how to configure a mobile application using [SDK V4](https://helpx.adobe.com/campaign/standard/administration/using/configuring-a-mobile-application-using-sdk-v4.html#setting-up-a-mobile-application-in-adobe-campaign) and [SDK V5](https://helpx.adobe.com/campaign/standard/administration/using/configuring-a-mobile-application-using-sdk-v5.html#channel-specific-application-configuration-in-adobe-campaign). 
...
* Target users on a specific Mobile App by selecting a Mobile App while defining the Campaign properties. This feature is for both Push and In-App Messaging channels.
  ...
  For more on this, refer to the [detailed documentation](https://helpx.adobe.com/campaign/standard/channels/using/creating-and-sending-a-push-notification.html).
...
* When selecting a content block using the Creative Designer interface, all the content blocks from the list are now loaded and displayed. (CAMP-27311)
  ...
  For more on this, refer to the [detailed documentation](https://helpx.adobe.com/campaign/standard/designing/using/adding-a-content-block.html).
