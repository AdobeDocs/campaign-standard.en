...
* **Email Feedback service** (beta) is a scalable service which captures feedback from the Enhanced MTA directly, thus improving reporting accuracy. This improvement is a private beta and will be deployed for all customers in 2021.
