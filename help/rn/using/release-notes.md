...
<table> 
 ...
 <tbody> 
  <tr> 
   <td> <p>The Azure Blob storage connector can now be used to import or export data to Adobe Campaign using a Transfer file workflow activity. </p>
...
<table> 
 <thead> 
  <tr> 
   <th> <strong>Substitution of address and personalization from Target Data</strong><br /> </th> 
  </tr> 
 </thead> 
 <tbody> 
  <tr> 
