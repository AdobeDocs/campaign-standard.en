...
uuid: c301d3dd-2409-4f9b-986c-455226011cc6
contentOwner: sauviat
products: SG_CAMPAIGN/STANDARD
audience: rn
content-type: reference
topic-tags: campaign-standard-releases
discoiquuid: 04533aa1-353a-4407-8800-66c4ded225be
...
* When configuring a mobile application in Campaign, the user can now know if the iOS certificate and Android server key have been successfully uploaded and their expiration date. (Available for SDK V5 Mobile Apps only)
* Target users on a specific Mobile App by selecting a Mobile App while defining the Campaign properties. This feature is for both Push and In-App Messaging channels. (Available for SDK V5 Mobile Apps only)
...
#### Emails, SMS messages and direct mail {#emails-sms-messages-and-direct-mail-4}
...
#### Emails, SMS messages and direct mail {#emails-sms-messages-and-direct-mail-5}
...
#### Profiles and audiences {#profiles-and-audiences-2}
...
#### Emails, SMS messages and direct mail {#emails-sms-messages-and-direct-mail-6}
...
#### Push notifications {#push-notifications-5}
...
#### Push notifications {#push-notifications-6}
