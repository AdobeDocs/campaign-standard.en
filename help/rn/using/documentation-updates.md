...
Information related to the Audience Destinations Service and Adobe Experience Platform Data Connector has been regrouped into a new section. 
...
Information on the Experience Cloud ID Service (ECID) has been added to the Adobe Experience Platform Data Connector documentation.
...
Dynamic reporting compatibility table has been added to better understand compatibility between dimensions and metrics. [Read more](https://experienceleague.adobe.com/docs/campaign-standard/assets/dynamic_report_compatibility.pdf)
...
The section including the list of authorizations has been removed. [Read more](https://experienceleague.adobe.com/docs/campaign-standard/assets/acs_rights.pdf) (PDF).
