...
uuid: 84ba15ee-5a88-4b07-9467-56e640499e30
...
discoiquuid: 54d59091-fbce-4034-b4e1-bda524563545
isreadyforlocalization: false
navTitle: Documentation Updates
publishexternaldate: 2018-11-20
sha1: 7573b81438434d02464194a20fb81ec7cb10d532
index: y
internal: n
snippet: y
---
...
Using Loops in Transactional Emails - [Read more](../../channels/using/event-transactional-messages.md#using-loops-in-a-transactional-message)
...
Added more information concerning the different type of audiences in Adobe Campaign. [Read more](../../audiences/using/about-audiences.md)
...
Learn how to simply make external contents fully editable with the Creative SDK by creating fragments from your existing emails. [Read more](../../designing/using/editing-existing-contents-with-the-email-designer.md#using-fragments-and-components-to-create-contents-supported-by-the-email-designer)

The list of HTML attributes for full compliance with the Creative Designer is now available in this [section](../../designing/using/editing-existing-contents-with-the-email-designer.md#html-tagging-to-ensure-compatibility-with-the-email-designer).
...
Learn the best practices for using Adobe hosted SFTP servers. [Read more](../../administration/using/external-accounts.md#setting-up-a-sftp-external-account)
...
Creative Designer for Email - [Read more](../../designing/using/about-email-content-design.md#using-the-email-designer)
...
Release notes have been reorganized in two pages so that you get a more global view of all the different releases: [Latest Release Notes](../../rn/using/release-notes.md) and [Previous release Notes](../../rn/using/year-2015-2016-release-notes.md)
...
## 16.11 - November 2016 release {#november-release-1}
...
## 16.10 - October 2016 release {#october-release-1}
...
## 16.9 - September 2016 release {#september-release-2}
