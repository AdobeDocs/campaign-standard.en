...
<tr>
  ...
  <td valign="top">
    ...
    <p><em>Discover the <a href="https://docs.campaign.adobe.com/doc/standard/en/api/ACS_API.html">Adobe Campaign API</a>.</em></p>
    <p><em>Learn how to use the <a href="integrating/using/about-adobe-experience-cloud-triggers.md">Adobe Experience Cloud Triggers</a>.</em></p>
    <br>
  </td>
</tr>
</table>
